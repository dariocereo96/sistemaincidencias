...
<%
    ...
    if (request.getSession().getAttribute("usuario") == null) {
        ...
        if (request.getParameter("idticket") != null) {
            ...
            if (ticket != null && ticket.getAsignadoA() == usuario.getId() && ticket.getEstado().equals("cerrado")) {
                tickets.add(ticket);
            }
            ...
            List<Ticket> lista = ticketDAO.obtenerTodosTicketsAsignadosTecnicoByEstado(usuario.getId(), "cerrado");
            ...
            tickets = ticketDAO.obtenerTodosTicketsAsignadosTecnicoByEstado(usuario.getId(),"cerrado");
        }
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <a href="listaticketscerrados.jsp" class="btn btn-success"><i class="fa fa-file" style="margin-right: 4px"></i>Listar Todo</a>
                ...
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" style="margin-bottom: 15px">
                                <div class="col-md-12">
                                    <label for="valoracion">Califiacion de la atencion</label>
