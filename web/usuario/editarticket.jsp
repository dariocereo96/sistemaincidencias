                ...
                <ul class="nav navbar-top-links navbar-right" style="padding-right: 40px">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="editarticket.jsp"><i class="fa fa-user fa-fw"></i><%= usuario != null ? usuario.perfilRol() : ""%></a></li>
                                ...
                                <div class="panel-body">
                                    <form action="${pageContext.request.contextPath}/TicketController?action=editar" method="post">
                                        ...
                                        <div style="text-align: right">
                                            ...
                                            <a href="${pageContext.request.contextPath}/usuario/listatickets.jsp" class="btn btn-danger">Cancelar</a>
                                        </div
                                    </form>
                                </div>
                            </div>
