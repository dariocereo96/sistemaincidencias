...
<%
    ...
    if (request.getSession().getAttribute("usuario") == null) {
        ...
        if (usuarioDAO.validarExisteEmpresa(usuario.getId())) {
            ticketsConteo = new TicketDAO(Conexion.getConexion()).contarTicketsUsuario(usuario.getId());
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row" style="padding: 10px">
                                        ...
                                        <div class="col-md-3">
                                            <a href="listatickets.jsp?estado=abierto">
                                                <div  style="background-color: #d9534f;text-align: center;color: #fff;border-radius: 10px">
                                                    <p style="font-size: 12px;font-weight: bold;">TICKETS PENDIENTES</p>
                                                    <i class="fa fa-ticket" style="font-size: 40px"></i>
                                                    <p><%=totalPendientes%></p>
                                                </div>
                                            </a>
                                        ...
                                        <div class="col-md-3">
                                            <a href="listatickets.jsp?estado=en proceso">
                                                <div  style="background-color: #0075b0;text-align: center;color: #fff;border-radius: 10px">
                                                    <p style="font-size: 12px;font-weight: bold;">TICKETS EN PROCESO</p>
                                                    <i class="fa fa-ticket" style="font-size: 40px"></i>
                                                    <p><%=totalAsignados%></p>
                                                </div>
                                            </a>
