...
<%
    ...
    if (request.getSession().getAttribute("usuario") == null) {
        ...
        if (request.getParameter("idticket") != null) {
            ...
            tickets = ticketDAO.obtenerTodosTicketsAsignadosByTipo(idTipo);
...
<html>
    <head>
        ...
        <title>Tickets asignados | Sistema Gestion Incidencias</title>
        <!-- Bootstrap Styles-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <a href="listaticketAsignados.jsp" class="btn btn-success"><i class="fa fa-file" style="margin-right: 4px"></i>Listar Todo</a>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody style="font-size: 13px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display: flex">
                                                            <a href='#' class="btn-custom" style="background-color: #0088cc;display: flex;justify-content: center" onclick="openModal('<%=ticket.getTitulo()%>', '<%=ticket.getDescripcion()%>', <%=ticket.getId()%>, '<%=ticket.getFechaCreacion()%>', '<%=ticket.getRazonSocial()%>', '<%=ticket.getLugar()%>', '<%=ticket.getEncargado()%>', '<%=ticket.getSubTipoTicket()%>', '<%=ticket.getDireccionEmpresa()%>', '<%=ticket.getTelefonoEmpresa()%> ')"><i class="fa fa-eye" style="margin-top: 2px;margin-right: 4px"></i>Ver</a>
                                                            <%
                                                                int rol4 = usuario != null ? usuario.getRolId() : -1;
                                                                if (rol4 == 5) {
                                                            %>
                                                            <a href="#" class="btn-custom" style="background-color: #c12e2a;display: flex;" onclick="openModal2('<%=ticket.getTitulo()%>', '<%=ticket.getDescripcion()%>', '<%=ticket.getId()%>')"><i class="fa fa-check-square" style="margin-top: 2px;margin-right: 4px"></i>Cerrar</a>
                                                            <a href='#' class="btn-custom" style="background-color: #398439;margin-right: 2px;display: flex;" onclick="openModal3('<%=ticket.getId()%>')"><i class="fa fa-user" style="margin-top: 2px;margin-right: 2px"></i>Cambiar</a>
                                                            <%
                                                                }
                                                            %>
                                                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="${pageContext.request.contextPath}/TicketController?action=asignarTecnico" method="post" id="formulario">
                        <input type="hidden" name="idTicket" id="idTicket2" value="-1">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h4 class="modal-title" id="myModalLabel3">Cambiar Tecnico</h4>
                        </div>
                        <div class="modal-body">
                            <label style="">Seleccione tecnico</label>
        ...
        <script>
                                                                ...
                                                                function openModal3(idTicket) {
                                                                    $('#idTicket2').val(idTicket);
                                                                    $('#myModal3').modal('show');
                                                                }
