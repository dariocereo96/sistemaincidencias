...
<%
    ...
    if (request.getSession().getAttribute("usuario") == null) {
        ...
        if (request.getParameter("id") != null) {
            tecnico = tecnicoDAO.obtenerTecnico(Integer.parseInt(request.getParameter("id")));
        } else {
...
<html>
    <head>
        ...
        <title>Editar tecnico | Sistema Gestion Incidencias</title>
        <!-- Bootstrap Styles-->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form onsubmit="validarFormulario(event)" action="${pageContext.request.contextPath}/TecnicoController?action=editar" method="post">
                                        <input type="hidden" name="idTecnico" value="<%= tecnico != null ? tecnico.getId() : "-1"%>"/>
                                        <div class="form-group">
                                            <label for="nombre">Cedula:</label>
                                            <input oninput="validarCedula(event)" value="<%=tecnico != null ? tecnico.getCedula() : ""%>" type="text" class="form-control" id="nombre" name="cedula" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="nombre">Nombre:</label>
                                            <input oninput="validarTexto(event)" value="<%= tecnico != null ? tecnico.getNombre() : ""%>"  type="text" class="form-control" id="nombre" name="nombre" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="apellido">Apellido:</label>
                                            <input oninput="validarTexto(event)" value="<%= tecnico != null ? tecnico.getApellido() : ""%>" type="text" class="form-control" id="apellido" name="apellido" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="correo">Correo:</label>
                                            <input value="<%= tecnico != null ? tecnico.getCorreo() : ""%>" type="email" class="form-control" id="correo" name="correo" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="telefono">Telefono:</label>
                                            <input oninput="validarTelefono(event)" value="<%=  tecnico != null ? tecnico.getTelefono() : ""%>" type="text" class="form-control" id="telefono" name="telefono">
                                        </div>
                                        <div class="form-group">
                                            <label for="direccion">Direccion:</label>
                                            <input value="<%= tecnico != null ? tecnico.getDireccion() : ""%>" type="text" class="form-control" id="telefono" name="direccion">
                                        </div>
