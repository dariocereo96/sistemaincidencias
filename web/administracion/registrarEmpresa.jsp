                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form onsubmit="validarFormulario(event)" action="${pageContext.request.contextPath}/EmpresaController?action=registrar" method="post">
                                        <div class="form-group">
                                            <label for="razonSocial">Razón Social:</label>
                                            <input type="text" value="<%= (empresa.getRazonSocial() != null) ? empresa.getRazonSocial() : ""%>" class="form-control"  id="razonSocial" name="razonSocial" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="ruc">RUC:</label>
                                            <input value="<%= (empresa.getRuc() != null) ? empresa.getRuc() : ""%>" oninput="validarRUC(event)" type="text" class="form-control" id="ruc" name="ruc" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="direccion">Dirección:</label>
                                            <input type="text" value="<%= (empresa.getDireccion() != null) ? empresa.getDireccion() : ""%>" class="form-control" id="direccion" name="direccion" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="telefono">Teléfono de contacto:</label>
                                            <input type="text" value="<%= (empresa.getTelefono() != null) ? empresa.getTelefono() : ""%>" oninput="validarTelefono(event)" class="form-control" id="telefono" name="telefono" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="correo">Correo de contacto:</label>
                                            <input type="email" value="<%= (empresa.getCorreo() != null) ? empresa.getCorreo() : ""%>" class="form-control" id="correo" name="correo" required>
                                        </div>
